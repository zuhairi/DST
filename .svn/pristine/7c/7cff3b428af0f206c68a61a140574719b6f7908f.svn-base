...
public class MapResultsControlPanelSource extends Composite{
	...
	public MapResultsControlPanelSource(MapResultsControlPanel parentView){
	...
	private void initializeComponents(){
		...
		cmbNode.addItem("sourceTracePct");
	...
	private void loadNodeScale(ArrayList<Float> scale,String variable){
		...
		if(variable.equals("sourceTracePct")){
			lblNodeScaleTitle.setText("Trace pct (%)");
		}
	}
