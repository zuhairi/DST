...
public class MapResultsControlPanelChemical extends Composite{
	...
	public MapResultsControlPanelChemical(MapResultsControlPanel parentView){
	...
	private void loadNodeScale(ArrayList<Float> scale,String variable){
		...
		if(variable.equals("chemicalCon")){
			lblNodeScaleTitle.setText("chemicalCon (mg/L)");
		}
	}
