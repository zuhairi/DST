...
function convertPoint (xString,yString){

   // get the coords
  var x = xString;
  var y = yString;

  // make sure it's the right "size" of number
  x = x / (Math.pow(10, (Math.floor(log10(x)) - 5)));
  y = y / (Math.pow(10, (Math.floor(log10(y)) - 5)));

  // do the conversion
  var osCoord = new OSRef(x, y);
  var llCoord = osCoord.toLatLng();
  llCoord.OSGB36ToWGS84();

  return llCoord.lat+"&"+llCoord.lng;
...
//////////////////////////////////////////////
//from JScoord (javascript library complete)
//////////////////////////////////////////////
