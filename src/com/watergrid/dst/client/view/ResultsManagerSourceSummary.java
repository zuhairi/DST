...
public class ResultsManagerSourceSummary extends Composite{
	...
	//labels to add data
	Label lblMinSourceTrace;		//sourceTrace
	Label lblMaxSourceTrace;
	...
	public ResultsManagerSourceSummary(ResultsManager parentView){
	...
	private void initializeComponents(){
		...
		Image imgLogo = new Image(images.traceBig());
		verticalPanelGlobal.add(imgLogo);
		
		Label lblTitle = new Label("SourceTrace Results Summary");
		...
		Label lblPressureTitle = new Label("Source Trace (%): ");
		grid.setWidget(1, 0, lblPressureTitle);
		
		lblMinSourceTrace = new Label("0.00");
		grid.setWidget(1, 2, lblMinSourceTrace);
		lblMaxSourceTrace = new Label("0.00");
		grid.setWidget(1, 4, lblMaxSourceTrace);
	...
	public void loadSummaryData(ArrayList<Float> summaryData){
		...
		lblMinSourceTrace.setText(String.valueOf(summaryData.get(0)));		
		lblMaxSourceTrace.setText(String.valueOf(summaryData.get(1)));
