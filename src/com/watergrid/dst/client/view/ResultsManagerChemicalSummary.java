...
public class ResultsManagerChemicalSummary extends Composite{
	...
	//labels to add data
	Label lblMinChemicalCon;		//chemical Con
	Label lblMaxChemicalCon;
	...
	public ResultsManagerChemicalSummary(ResultsManager parentView){
	...
	private void initializeComponents(){
		...
		Image imgLogo = new Image(images.chemicalBig());
		verticalPanelGlobal.add(imgLogo);
		
		Label lblTitle = new Label("Chemical Concentration Results Summary");
		...
		Label lblPressureTitle = new Label("Chemical Concentration (mg/L): ");
		grid.setWidget(1, 0, lblPressureTitle);
		
		lblMinChemicalCon = new Label("0.00");
		grid.setWidget(1, 2, lblMinChemicalCon);
		lblMaxChemicalCon = new Label("0.00");
		grid.setWidget(1, 4, lblMaxChemicalCon);
		...
		btnComponentDetails.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				parentView.showChemicalDetails();
			}
		});
	...
	public void loadSummaryData(ArrayList<Float> summaryData){
		...
		lblMinChemicalCon.setText(String.valueOf(summaryData.get(0)));		
		lblMaxChemicalCon.setText(String.valueOf(summaryData.get(1)));
